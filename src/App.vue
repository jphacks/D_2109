      ...
      description_lists: [
        {
          ...
          before_code: "customers = Customer.objects.filter(active_flag=False).order_by('id')[:10].values('id', 'name', 'phone', 'mail', 'gender', 'birth_date', 'active_flag')",
          after_code: "# [trim] Warning: 1行あたりの行数は最大80文字です.適切な位置で折り返してください.\ncustomers = Customer.objects.filter(active_flag=False).order_by('id')[:10].values('id', 'name', 'phone', 'mail', 'gender', 'birth_date', 'active_flag') ",
        },
        {
          title: "スタイルに関するルール",
          title_bg_path: require("./assets/stickynote_blue.svg"),
          ...
          before_code: "class ValueNaming(Naming):\n    def __init__():\n        super().__init__()\n\ndef add_box(obj):\n    box.append(obj)",
          after_code: "class ValueNaming(Naming):\n    def __init__():\n        super().__init__() \n\n\ndef add_box(obj):\n    box.append(obj) ",
        },
        {
          title: "スタイルに関するルール",
          title_bg_path: require("./assets/stickynote_blue.svg"),
          ...
          before_code: "class Naming():\n    box = []\n\n\n    def __init__():\n        pass\n    def add_box(obj):\n        self.box.append(obj)\n",
          after_code: "class Naming():\n    box = [] \n    \n    def __init__():\n        pass \n\n    def add_box(obj):\n        self.box.append(obj)",
        },
        {
          title: "importに関するルール",
        ...
        },
        {
          ...
          before_code: "def    add_box(message:   str)  ->    None:\n    self.box.append(message)\n    count    +=  1",
          after_code: "def add_box(message:str) -> None:\n    self.box.append(message) \n    count += 1 ",
        },
        {
          title: "命名規則に関するルール",
          ...
          before_code: "# 関数: snakeケースのみ許容すると仮定\ndef addBox(obj):\n    box.append(obj)",
          after_code: "# [trim] Warning: 関数名に大文字は含められません.\ndef addBox(obj):\n    box.append(obj) ",
        },
      ],
    };
  },
